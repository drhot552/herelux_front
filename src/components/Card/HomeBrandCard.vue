...
export default{
  ...
  methods:{
    ...
    readMore(){
      this.$store.dispatch('FETCH_BRANDCATEGORYLIST_READMORE',{brand:this.$store.state.brandcateogry_brand, category:this.$store.state.brandcategory_category});
    },
    popup(){
      //여자
    ...
    categorySelect(key){
      ...
      this.$store.dispatch('FETCH_BRANDCATEGORYLIST_READMORE',{brand:this.$store.state.brandcateogry_brand, category:key, category_type:this.$store.state.brandcateogry_category_type, sex:this.sex});
